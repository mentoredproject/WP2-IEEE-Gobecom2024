...
from adaptive_padding.padding.strategies_mapping_factory import create_dynamic_strategies_mapping
from constants import FolderPath


def main():
    strategies: Dict[str, PaddingStrategy] = create_dynamic_strategies_mapping()
